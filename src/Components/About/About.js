...
const About = () => {
    return (
        <div>
            <h1 style={{marginTop:'70px'}} className='text-info'>About bdTravel</h1>
            <div className='d-flex justify-content-center align-items-center w-50 mx-auto ' style={{textAlign:'justify'}}>
