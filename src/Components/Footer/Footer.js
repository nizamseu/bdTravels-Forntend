    ...
    return (
        <div style={{color:'gray'}} className='row d-flex justify-content-center mt-5 p-5 '>
           ...
           <div className="col-md-4">
             ...
             <Link className='footer' to='/my'>My Item</Link><br />
              <Link className='footer' to='/manage'>Manage Item</Link><br />
            </div>  
